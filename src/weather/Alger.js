...
const URL = `https://api.open-meteo.com/v1/forecast?latitude=36.77&longitude=3.48&hourly=temperature_2m,precipitation_probability&daily=weathercode,sunrise,sunset&current_weather=true&timezone=auto`;
const URL2 = `https://api.open-meteo.com/v1/forecast?latitude=36.7664&longitude=3.4772&hourly=temperature_2m&daily=temperature_2m_max,temperature_2m_min&timezone=auto`
...
function Alger() {
  ...
  useEffect(() => {
    document.title = 'Weather in Boumerdes';
  }, []);

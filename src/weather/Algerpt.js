...
const URL = `https://api.aladhan.com/v1/timingsByCity/24-05-2023?city=Algiers&country=Algeria&method=8`
...
function Algerpt() {
  ...
  useEffect(() => {
    document.title = 'Prayer times in Algiers';
  }, []);
  ...
  return (
    <div className="Alger text-center">
      <div className="header display-1"><b>ALGER</b> PRAYER TIMES</div>
      <div className="place" >
